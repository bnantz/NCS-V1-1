namespace MetaBuilders.WebControls {
	...
	/// The text of the message displayed is set with the <see cref="ConfirmedImageButton.Message"/> property.
	...
	/// </code>
	/// </example>
	public class ConfirmedImageButton : ImageButton {
        
		/// <summary>
		/// Initializes a new instance of the <see cref="ConfirmedImageButton"/> class.
		/// </summary>
		/// <remarks>
		/// Use this constructor to create and initialize a new instance of the <see cref="ConfirmedImageButton"/> class.
		/// </remarks>
		public ConfirmedImageButton() : base() {
